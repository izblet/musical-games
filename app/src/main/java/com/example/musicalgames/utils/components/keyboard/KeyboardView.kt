...
class KeyboardView(context: Context, attrs: AttributeSet?) : View(context, attrs) {
    ...
    private val whiteKeyPaint = ComponentPaints.getWhiteFillPaint(context)
    private val blackKeyPaint = ComponentPaints.getBlackFillPaint(context)
    private val darkgrayPaint = ComponentPaints.getDarkgrayFillPaint(context)
    private val lightgrayPaint = ComponentPaints.getLightgrayFillPaint(context)
    private val blackKeyStroke = ComponentPaints.getBlackStrokePaint(context)
    private val whiteKeyStroke = ComponentPaints.getWhiteStrokePaint(context)
    private val blueFillPaint = ComponentPaints.getBlueFillPaint(context)
